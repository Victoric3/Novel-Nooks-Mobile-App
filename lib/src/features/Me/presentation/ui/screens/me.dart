...
class _MeScreenState extends ConsumerState<MeScreen> with TickerProviderStateMixin {
    ...
    return Container(
      ...
      child: ListTile(
        ...
        trailing: Switch(
          value: isDark,
          onChanged: (value) {
            ref.read(currentAppThemeNotifierProvider.notifier).updateCurrentAppTheme(value);
          },
          activeColor: isDark ? AppColors.neonCyan : AppColors.brandDeepGold,
          activeTrackColor: isDark 
              ? AppColors.neonCyan.withOpacity(0.3) 
  ...
  Widget _buildSupportButton(bool isDark, String label, IconData icon, VoidCallback onTap) {
    return Expanded(
      child: InkWell(
        onTap: onTap,
        borderRadius: BorderRadius.circular(12),
              ...
              children: [
                Expanded(
                  child: ElevatedButton.icon(
                    ...
                    style: ElevatedButton.styleFrom(
                      ...
                      foregroundColor: isDark ? Colors.black : AppColors.brandDeepGold,
                      padding: const EdgeInsets.symmetric(vertical: 12),
                ...
                Expanded(
                  child: ElevatedButton.icon(
                    ...
                    icon: Icon(isPremium ? MdiIcons.crownOutline : MdiIcons.crown),
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: currentCoins >= 10 ? () => _showConvertCoinsModal(context, isDark) : null,
                style: ElevatedButton.styleFrom(
                    ...
                    Container(
                      ...
                      child: SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          child: const Text('Update Username', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                        ),
                      ),
                    ),
                  ],
                  ...
                  child: SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        ...
                        // Get user email
                        final userEmail = ref.read(userProvider).valueOrNull?.email;
                        if (userEmail != null) {
                          ...
                          NotificationService().showNotification(
                            message: 'Unable to retrieve your email. Please try again.',
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextField(
                    ...
                    keyboardType: TextInputType.number,
                    decoration: InputDecoration(
                      hintText: 'Your budget for premium services',
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: const Text('Schedule Call', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                    ),
                  ),
                ],
              ),
